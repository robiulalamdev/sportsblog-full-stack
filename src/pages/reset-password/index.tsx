    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-white">
      {step === 1 && (
        <div className="max-w-[674px] w-full mx-auto grid grid-cols-1 gap-[18px]">
          <div className="mb-[64px]">
            <h1 className="text-[#040308] font-bold text-[38px]">
              Forgot Password
            </h1>
            <p className="text-[#040308] text-[21px] mt-[10px]">
      ...
      {step === 2 && (
        <div className="max-w-[674px] w-full mx-auto grid grid-cols-1 gap-[18px]">
          ...
          <div>
            <p className="mb-[14px] text-[#040308] text-[21px]">
      ...
      {step === 4 && (
        <div className="max-w-[674px] w-full mx-auto grid grid-cols-1 gap-[18px]">
          <div className="mb-[64px] flex flex-col justify-center items-center gap-[24px]">
            {iPRS}
            <h1 className="text-[#040308] text-[24px] font-inter font-semibold">
