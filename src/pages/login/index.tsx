...
const LoginPage = () => {
  return (
    <AuthLayout>
      ...
      >
        <div className="max-w-[727px] max-h-[727px] w-full h-full backdrop-blur-xl md:border-[1px] border-white rounded-[44px] flex justify-center items-center px-2 md:px-0">
