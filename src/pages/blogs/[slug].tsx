...
import img2 from "../../assets/images/blog-details/img2.png";
...
const BlogDetails = () => {
  return (
    <div className="bg-[#181818]">
      <div
        className="max-w-[1900px] mx-auto w-full h-[300px] sm:h-[450px] md:h-[600px] lg:h-[658px]"
        style={{
      ...
      >
        <Header className="bg-black/70 backdrop-blur" />
      </div>
      <div className="max-w-theme mx-auto px-theme">
        ...
        /> */}
          <h1 className="text-[22px] md:text-[32px] lg:text-[48px] text-white font-bold font-roboto md:leading-[57.6px] mt-6">
          ...
          <div className="mt-[48px] flex justify-between items-center gap-8 flex-wrap">
            <div className="mt-[10.32px] flex items-center gap-[13.77px]">
              ...
              <div className="flex flex-col gap-[6px]">
                <p className="text-[#FFFFFF] text-[14px] font-roboto font-semibold leading-[18.4px]">
                  by Mike Fink
                </p>
                <div className="flex items-center gap-[6.99px] text-[#FFFFFF] text-[12.045px] leading-[18.4px] font-roboto">
                  <p className="text-[#FFFFFF] text-sm leading-[18.4px] font-roboto">
                    11 Jan 2022
                  </p>
                  {iDot}
                  <p className="text-[#FFFFFF] text-sm leading-[18.4px] font-roboto">
            ...
            <Button
              className="size-[32px] p-0 rounded-full shadow-none hover:shadow-none bg-[#F4F4F4] flex justify-center items-center text-white hover:bg-primary hover:text-white"
              placeholder=""
            >
              {iLink}
            </Button>
        ...
        <section className="mt-[80px] pb-[100px]">
          <div className="max-w-[768px] mx-auto mt-[30px] md:mt-[104px]">
            <h1 className="text-white font-bold text-[25px] md:text-[47px] leading-[48px]">
              Introduction
            </h1>
            <p className="text-justify text-base leading-[24px] text-white mt-6 font-roboto">
            ...
            <Image
              ...
              alt=""
            />
            <div className="border-l border-white mt-4 pl-2 text-white text-sm leading-[21px] font-roboto">
              <p>Image caption goes here</p>
            </div>

            <p className="mt-[68px] font-roboto text-xl font-bold leading-[28px] text-white">
              Dolor enim eu tortor urna sed duis nulla. Aliquam vestibulum,
              nulla odio nisl vitae. In aliquet pellentesque aenean hac
              vestibulum turpis mi bibendum diam. Tempor integer aliquam in
              vitae malesuada fringilla.
            </p>
            <p className="mt-4 text-white text-base leading-[24px]">
            ...
            <div className="border-l-[2px] border-white pl-6 font-inter text-xl text-white mt-[36px]">
              <i>
            ...
            <p className="text-justify text-base leading-[24px] text-[#FFFFFF] mt-6 font-roboto">
            ...
            <h1 className="text-white font-bold text-[32px] leading-[48px] mt-[40px]">
              Conclusion
            </h1>
            <p className="text-justify text-base leading-[24px] text-white mt-5 font-roboto">
              Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam
              suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum
              quis montes, sit sit. Tellus aliquam enim urna, etiam. Mauris
              posuere vulputate arcu amet, vitae nisi, tellus tincidunt. At
            ...
            <p className="text-justify text-base leading-[24px] text-white mt-4 font-roboto">
          ...
          <div>
            <h1 className="text-[18px] font-roboto font-semibold leading-[27px] text-white">
              Share this post
            </h1>
          ...
          <div className="flex items-start gap-2 flex-wrap">
            {["Mom", "Food", "Books", "WordPress"].map(
              (tag: string, index: number) => (
                ...
                >
                  <Button
                    className="px-[8px] py-[4px] bg-[#F4F4F4] text-white rounded shadow-none hover:shadow-none text-sm font-semibold leading-[21px]"
                    placeholder=""
                  >
                    {tag}
                  </Button>
        ...
        <div className="flex justify-between items-center mb-[34px]">
          <div>
            <h1 className="text-[24px] md:text-[32px] lg:text-[48px] font-bold text-white leading-[42px] font-roboto">
              Popular
            </h1>
            <p className="text-white text-[18px] font-roboto leading-[27px] mt-6 hidden md:block">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.{" "}
            </p>
          </div>
          <Button
            placeholder=""
            className="hover:shadow-primary hover:bg-primary hover:border-white hover:text-white border border-black text-white bg-white font-inter text-sm md:text-base leading-[24px] px-6 py-1 md:py-3 rounded-[5px]"
          >
            View all
          </Button>
        </div>
